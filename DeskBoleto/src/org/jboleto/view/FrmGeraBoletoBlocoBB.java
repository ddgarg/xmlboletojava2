 ...
 * @author  wanderson
 */
public class FrmGeraBoletoBlocoBB extends javax.swing.JFrame {
    ...
    private void jBtnProcessarBoletosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnProcessarBoletosActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < jTblBoletos.getRowCount(); i++) {
                ...
                jBoletoBean.setInstrucao2(jTblBoletos.getValueAt(i, 12).toString());
                
                jBoletoBean.setInstrucao3(jTblBoletos.getValueAt(i, 13).toString());
