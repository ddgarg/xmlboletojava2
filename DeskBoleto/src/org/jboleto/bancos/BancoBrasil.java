...
public class BancoBrasil implements Banco {
    ...
    private String getCampoLivre() {
        ...
        //String campo = boleto.getNumConvenio() + boleto.getNossoNumero() + boleto.getCarteira() ;
        String campo = boleto.getNumConvenio() + boleto.getNossoNumero() + "21" ; // Modificado 05/12/2008
        //String campo = boleto.getNumConvenio() + boleto.getNossoNumero() ;
        return campo;
    }
